...
public class EmpresaDAO extends ConexionBd{
     ...
     */
    public int save(String name,String ruc, int statem,int trabajadores,int mon){
       int i=0;
        try{
            ...
            objEmpresa = new Empresa(0,name,ruc,false,now,now,trabajadores,mon);
     ...
     */
    public int update(int id, String name,String ruc, int state,int trabajadores, int mon){
       int i=0;
        try{
            Date date = new Date(0000-00-00);
            //Preparando
            ...
            objEmpresa = new Empresa(id,name,ruc,false,now,now,trabajadores,mon);
            //Iniciando consulta y asignando valores
